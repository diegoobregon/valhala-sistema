...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [CommonModule, FormsModule, TransComponent],
  template: `
  <!-- LOGIN -->
  ...
  <div class="layout" *ngIf="auth.isLoggedIn">
    <aside class="sidebar">
      ...
      <nav class="snav">
        ...
        <a *ngIf="puede(['ADMIN','MECANICO'])" [class.on]="view==='trans'" (click)="view='trans'">Transacciones (Check-Out / Check-In)</a>
      </nav>
    ...
    <main class="content">
      ...
      <app-trans *ngIf="view==='trans'"></app-trans>
...
export class App implements OnInit {
  ...
  tituloView() {
    ...
    return m[this.view] || 'Transacciones | Check-Out / Check-In (RF-05, RF-06)';
  }
